...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        pc.setParent("com.carl.blog"); //父包名
        pc.setController(MODULE_NAME + ".controller"); // com.carl.blog.article.controller
        ...
        pc.setEntity("entities");//实体类存储包名 com.carl.blog.entities
...
//        strategy.setTablePrefix("carl_"); // 去掉表前缀
